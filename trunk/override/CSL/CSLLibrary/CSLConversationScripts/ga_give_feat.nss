...
// TDE 10/1/08 - Set notification parameters for FeatAdd
...
void main(string sTarg, int nFeat, int bCheckReq, int bAllPartyMembers)
{
	...
	{
    	if ( !bAllPartyMembers ) 
			FeatAdd(oPC, nFeat, bCheckReq, TRUE, TRUE);
		...
		else
		{
	        ...
	        {
	            FeatAdd(oTarg, nFeat, bCheckReq, TRUE, TRUE);
