...
/*
	...
	Params:
		string sTarget - Uses the standard CSLGetTarget() function, default is the PC Speaker (or OBJECT_SELF from Command Console)
...
{
	object oTarget = CSLGetTarget(sTarget, GetStandardTargetDefualt());	
	int nDurationType = CSLGetDurationType(sDurationType);
