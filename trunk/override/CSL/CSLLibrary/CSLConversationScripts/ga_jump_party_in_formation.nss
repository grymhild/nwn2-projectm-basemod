...
//		member's associate state for "CSL_ASC_MODE_STAND_GROUND" should be set to FALSE. 
...
void main(string sWaypoint, int iFormationNum, float fFormationTightness, int bDisableNoise)
{
	...
	{
		case 0:
			SCGroupSetBMAFormation(sGroupName, fFormationTightness);
			break;
		case 1:
			SCGroupSetLineFormation(sGroupName, fFormationTightness);
			break;
		case 2:
			SCGroupSetSemicircleFormation(sGroupName, FORMATION_SEMICIRCLE_FACE_OUT, fFormationTightness);
			break;
		case 3:
			SCGroupSetCircleFormation(sGroupName, FORMATION_HUDDLE_FACE_OUT, fFormationTightness);
			break;
		case 4:
			SCGroupSetRectangleFormation(sGroupName, fFormationTightness);
			break;
		default:
			SCGroupSetBMAFormation(sGroupName, fFormationTightness);
			break;
	...
	{
		case 0:
			SCGroupSetNoise(sGroupName, 0.0f, 10.0f, 0.5f);
			break;
		case 1:
			break;
		default:
	...
	SCGroupJumpToWP(sGroupName, sWaypoint);
}