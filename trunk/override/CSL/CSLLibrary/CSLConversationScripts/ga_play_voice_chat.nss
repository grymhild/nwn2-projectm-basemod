...
/*
		...
		* string sTag is the tag of the creature that you want to perform 
		...
		See ginc_param_const->CSLGetTarget() for more information.
...
{
	object oTarget = CSLGetTarget( sTag );
	...
	{
		if (DEBUGGING >= 4) { CSLDebug( "ga_play_voice_chat ERROR: " + sTag + " is not a valid object!", oTarget, oTarget, "SlateGray" ); }
	}
}
