...
void RubyNightmareBlade(object oTarget)
{
	...
	DelayCommand(0.3f, TOBStrikeWeaponDamage(oWeapon, nHit, oTarget, 0, FALSE, FALSE, 2));
}
...
{	
	...
	object oTarget = TOBGetManeuverObject(oToB, 71);
	...
	if (nConcentration >= nFoeAC)
	{
		...
		HkApplyEffectToObject(DURATION_TYPE_TEMPORARY, eRNB, oPC, 6.0f);
		TOBExpendManeuver(71, "STR");
	}
	else
	{
