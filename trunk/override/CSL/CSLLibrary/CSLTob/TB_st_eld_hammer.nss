...
{	
	...
	object oTarget = TOBGetManeuverObject(oToB, 151);
	...
	DelayCommand(0.3f, TOBStrikeWeaponDamage(oWeapon, nHit, oTarget, d6(6), TRUE));
	TOBExpendManeuver(151, "STR");
}
