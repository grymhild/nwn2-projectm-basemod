...
void SuperiorUnarmedStrike()
{
	...
	if (!GetIsObjectValid(oWeapon))
	{
		...
		{
			nDamage = CSLGetDamageBonusConstantFromNumber(nMonkFists + nFists);
		...
		HkApplyEffectToObject(DURATION_TYPE_TEMPORARY, eDamage, oPC, 1.0f);
	}
