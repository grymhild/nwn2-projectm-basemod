...
{	
	...
	HkApplyEffectToObject(DURATION_TYPE_TEMPORARY, eAttack, oPC, 6.0f);
	HkApplyEffectToObject(DURATION_TYPE_TEMPORARY, eSurge, oPC, 2.0f);
	PlayVoiceChat(VOICE_CHAT_PAIN3, oPC);
	CSLPlayCustomAnimation_Void(oPC, "*rage", 0);
	TOBExpendManeuver(85, "STR");
}
