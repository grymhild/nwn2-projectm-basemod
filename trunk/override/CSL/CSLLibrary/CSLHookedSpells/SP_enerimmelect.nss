...
void main()
{
	//scSpellMetaData = SCMeta_SP_enerimmelect();
	//if (!X2PreSpellCastCode()) { return; }  // If code within the PreSpellCastHook (i.e. UMD) reports FALSE, do not run this spell
	//--------------------------------------------------------------------------
	//Prep the spell
	//--------------------------------------------------------------------------
	object oCaster = OBJECT_SELF;
	int iSpellId = SPELL_ENERGY_IMMUNITY_ELECTRICAL;
	...
	SCUnstackEnergyImmunity( SPELL_ENERGY_IMMUNITY_ELECTRICAL, oCaster, oTarget );
