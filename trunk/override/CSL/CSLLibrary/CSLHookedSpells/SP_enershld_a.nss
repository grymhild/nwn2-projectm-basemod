...
void main()
{	
	//scSpellMetaData = SCMeta_SP_enershldls_a();
	//if (!X2PreSpellCastCode()) { return; }  // If code within the PreSpellCastHook (i.e. UMD) reports FALSE, do not run this spell
	//--------------------------------------------------------------------------
	//Prep the spell
	//--------------------------------------------------------------------------
	object oCaster = OBJECT_SELF;
	int iSpellId = SPELL_Energized_Shield_A;
	...
	effect eDamShld = EffectDamageShield(0, DAMAGE_BONUS_2d4, iDamageType);
	effect eDamRes = EffectDamageResistance(iDamageType,10, 0);	
