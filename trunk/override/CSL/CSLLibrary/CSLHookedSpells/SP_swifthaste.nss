...
void main()
{
	...
	int iSpellId = SPELL_SWIFT_HASTE;
	...
	float fDuration = HkApplyMetamagicDurationMods( HkApplyDurationCategory(d4() + 1, SC_DURCATEGORY_ROUNDS) );
	...
	HkApplyEffectToObject(DURATION_TYPE_TEMPORARY, eAC, oTarget, RoundsToSeconds(1));
