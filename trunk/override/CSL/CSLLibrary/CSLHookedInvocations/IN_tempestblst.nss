...
//:: into a tempest blast. This blast deals electrical damage and any creatures
//:: failing a Reflex save are dazed for 1 round.
...
void main()
{
	...
	int iSpellId = SPELL_I_TEMPEST_BLAST;
	...
	DoShapeMetaDoom(oCaster, METAMAGIC_INVOC_TEMPEST_BLAST);
