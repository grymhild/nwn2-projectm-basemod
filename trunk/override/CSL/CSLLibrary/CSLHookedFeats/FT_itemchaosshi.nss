...
void main()
{
	int iAttributes = SCMETA_ATTRIBUTES_MAGICAL | SCMETA_ATTRIBUTES_INTERNAL | SCMETA_ATTRIBUTES_SOMANTICCOMP | SCMETA_ATTRIBUTES_TURNABLE | SCMETA_ATTRIBUTES_CANTCASTINTOWN;
	...
	// happens
	//---------------------------------------------------------------------------
	int nChance = HkGetSpellPower(OBJECT_SELF) * 2;
	...
	{
			int bMelee = GetDistanceBetween(oSpellOrigin,oTarget) < 4.0f;
			int nRandom;


			FloatingTextStrRefOnCreature(100925, oSpellOrigin);
			FloatingTextStrRefOnCreature(100925, oTarget);
			...
			switch (nRandom)
			{
				case 0:
							...
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eDur,oTarget,RoundsToSeconds(d2()));
				...
				case 1:
							...
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eVis,oTarget,4.0f);
							HkApplyEffectToObject(DURATION_TYPE_INSTANT,eEffect,oTarget);
							DelayCommand(0.3f,HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eDur,oTarget,4.0f));
							break;
				...
				case 2:
							...
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eVis,oTarget,4.0f);
							HkApplyEffectToObject(DURATION_TYPE_INSTANT,eEffect,oTarget);
							DelayCommand(0.3f,HkApplyEffectToObject(DURATION_TYPE_INSTANT,eDur,oTarget));
							break;
				...
				case 4: eEffect = EffectSlow();
							...
							eDur = EffectLinkEffects (eEffect,eDur);
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eDur,oTarget,RoundsToSeconds(d4()));
							HkApplyEffectToObject(DURATION_TYPE_INSTANT,eVis,oTarget);
							break;
				...
				case 6:
							...
							HkApplyEffectToObject(DURATION_TYPE_INSTANT,eVis,oTarget);
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eEffect,oTarget,6.0f);
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eDur,oSpellOrigin,4.0f);
							break;
				...
				case 7:
							...
							HkApplyEffectToObject(DURATION_TYPE_INSTANT,eVis,oTarget);
							HkApplyEffectToObject(DURATION_TYPE_TEMPORARY,eDur,oTarget,RoundsToSeconds(d3()));
							break;
