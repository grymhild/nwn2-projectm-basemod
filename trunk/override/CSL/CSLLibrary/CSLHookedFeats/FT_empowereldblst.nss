...
void main()
{
	...
	int iSpellId = SPELLABILITY_EMPOWER_ELDBLAST;
	...
	ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_MAGBLUE), oCaster);
	SetLocalInt(oCaster, "EmpEldBlast", 1);
