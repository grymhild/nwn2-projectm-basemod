...
void main()
{
	...
	SignalEvent(oTarget, EventSpellCastAt(oCaster, SPELLABILITY_BOLT_ABILITY_DRAIN_CONSTITUTION));
	...
	if (iTouch != TOUCH_ATTACK_RESULT_MISS )
	{
		...
		if ( iAdjustedDamage >= SAVING_THROW_ADJUSTED_FULLDAMAGE )
		{
			...
			HkApplyEffectToObject(DURATION_TYPE_PERMANENT, eBolt, oTarget, RoundsToSeconds(iHD));
