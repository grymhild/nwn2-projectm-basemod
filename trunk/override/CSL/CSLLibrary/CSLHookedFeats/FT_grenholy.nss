...
void main()
{
	...
	SCDoGrenade(nDmg,nSplashDmg,VFX_HIT_SPELL_HOLY,VFX_HIT_AOE_HOLY,DAMAGE_TYPE_DIVINE,RADIUS_SIZE_MEDIUM,OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE, RACIAL_TYPE_UNDEAD);
