...
void main()
{
	...
	SignalEvent(oTarget, EventSpellCastAt(OBJECT_SELF, SPELLABILITY_BOLT_SHARDS, TRUE ));
	//Adjust the damage based on the Reflex Save, Evasion and Improved Evasion.
	//iDamage = HkGetReflexAdjustedDamage(iDamage, oTarget, iDC);
	...
	if (iTouch != TOUCH_ATTACK_RESULT_MISS )
	{
		...
		//Set damage effect
		eBolt = EffectDamage(iDamage, DAMAGE_TYPE_PIERCING, DAMAGE_POWER_PLUS_ONE);
		if(iDamage > 0)
		{
