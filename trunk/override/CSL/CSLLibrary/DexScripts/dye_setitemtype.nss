...
void main(int ItemTypeID)
{
    object oPC = GetPCSpeaker(), oitem;
	string sOutput;

    SetLocalInt(oPC, "ItemTypeToDye", INVENTORY_SLOT_CHEST);
    object oItem = GetItemInSlot(INVENTORY_SLOT_CHEST, oPC);

	if (ItemTypeID==INVENTORY_SLOT_CHEST)
	{
	    if (GetIsObjectValid(oItem))
		{
	        ...
	        sOutput = "Leather 1: " + IntToString(iLeather1) + " - " + ClothColor(iLeather1);
	        sOutput += "\nLeather 2: " + IntToString(iLeather2) + " - " + ClothColor(iLeather2);
	        sOutput += "\nCloth 1: " + IntToString(iCloth1) + " - " + ClothColor(iCloth1);
	        sOutput += "\nCloth 2: " + IntToString(iCloth2) + " - " + ClothColor(iCloth2);
	        sOutput += "\nMetal 1: " + IntToString(iMetal1) + " - " + MetalColor(iMetal1);
	        sOutput += "\nMetal 2: " + IntToString(iMetal2) + " - " + MetalColor(iMetal2);
