...
See the library _SCInclude_DeckOfMany for how the individual cards
...
void main()
{
	...
	int nCards = HkGetSpellPower( OBJECT_SELF ); // OldGetCasterLevel(OBJECT_SELF);
	...
	DestroyObject(oDeck, SC_DECK_DELAY * 20);
}
