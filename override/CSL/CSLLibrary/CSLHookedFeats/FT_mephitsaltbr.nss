...
void main()
{
	...
	iDamage = HkGetSaveAdjustedDamage(SAVING_THROW_REFLEX,SAVING_THROW_METHOD_FORHALFDAMAGE,iDamage, oTarget, HkGetSpellSaveDC(),SAVING_THROW_TYPE_ACID);
	//Make a ranged touch attack
	int iTouch = CSLTouchAttackRanged(oTarget);
	if(iDamage == 0) {iTouch = TOUCH_ATTACK_RESULT_MISS ;}
