...
//::///////////////////////////////////////////////////
#include "_HkSpell"
void ManticoreAttack(int nD6Dice, int nCap, int iSpellId, int nMIRV = VFX_IMP_MIRV, int nVIS = VFX_IMP_MAGBLUE, int nDAMAGETYPE = DAMAGE_TYPE_MAGICAL, int nONEHIT = FALSE)
{
...
void main()
{
	//scSpellMetaData = SCMeta_FT_manticorespi();
	//SCDoMissileStorm(int nD6Dice, int nCap, int iSpellId, int nMIRV = VFX_IMP_MIRV, int nVIS = VFX_IMP_MAGBLUE, int nDAMAGETYPE = DAMAGE_TYPE_MAGICAL, int nONEHIT = FALSE)
