...
void main()
{
	...
	SCDoGrenade(nDmg,nSplashDmg,VFX_HIT_SPELL_ACID,VFX_HIT_AOE_ACID,DAMAGE_TYPE_ACID,RADIUS_SIZE_HUGE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
}