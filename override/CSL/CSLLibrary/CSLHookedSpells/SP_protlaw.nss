...
/*
	...
	mind-affecting spells cast by lawful creatures
*/
//:://////////////////////////////////////////////
...
void main()
{
	...
	int iSpellId = SPELL_PROTECTION_FROM_LAW;
	...
	//Change the effects so that it only applies when the target is law
	//Try wrapping the sanctuary effect in the Law wrapper and see if the effect works.
