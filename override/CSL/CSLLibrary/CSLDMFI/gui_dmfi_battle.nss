...
void main(string sInput)
{
	...
	if (GetIsPC(oTarget))
	{
		CSLMessage_SendText(oSpeaker,"Action done to PC: " + GetName(oTarget),FALSE,COLOR_BLUE);
	}
	CSLMessage_SendText(oSpeaker, "Battle Effects: Str: " + IntToString(nStrEffect) + " Dex: " + IntToString(nDexEffect) + " Con: " + IntToString(nConEffect) + " SR: " + IntToString(nSREffect));
