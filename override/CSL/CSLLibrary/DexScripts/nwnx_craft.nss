...
struct strTint XPCraft_HLSToTintStruct(int iHue, int iLum, int iSat)
{
	...
	{
		fR = XPCraft_QqhToRgb(q1,q2,fT+120.0);
		fG = XPCraft_QqhToRgb(q1,q2,fT);
		fB = XPCraft_QqhToRgb(q1,q2,fT-120.0);
	}
