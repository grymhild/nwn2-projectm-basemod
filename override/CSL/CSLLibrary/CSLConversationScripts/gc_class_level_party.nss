// gc_class_level_party (int nClass, string sLevelCheck, string sTarget)
/*
	This script checks to see if any character has a certain number of levels of a particular class.
	Parameters:
    ...
    string sLevelCheck 	= The level to check for this class.
                          ...
                          Default value if left blank is "!0"
...
int StartingConditional(int nClass, string sLevelCheck, int bInConversation = 0)
{
	...
	int nClassLevel = GetLevelByClass(nClass, oPM);
    ...
    {
		if ( CSLCompareInts(nClassLevel, sLevelCheck) )
		{	
			return TRUE;
		}
