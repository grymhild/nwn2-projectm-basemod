...
{	
	...
	int iSpellId = SPELL_SHIVERING_TOUCH; // put spell constant here
	...
	int nDam = HkApplyMetamagicVariableMods(d6(3), 18);
	
	

	SignalEvent(oTarget, EventSpellCastAt(oCaster, iSpellId, FALSE));
	//SPRaiseSpellCastAt(oTarget, TRUE, SPELL_SHIVERING_TOUCH, oCaster);
