...
//----------------------------------------------------------------------------
// @bug above it's defined with different constant
// void  SetExecutedScriptReturnValue(int nValue = X2_EXECUTE_SCRIPT_END) instead of X2_EXECUTE_SCRIPT_CONTINUE
void  SetExecutedScriptReturnValue(int nValue = X2_EXECUTE_SCRIPT_END )
{
